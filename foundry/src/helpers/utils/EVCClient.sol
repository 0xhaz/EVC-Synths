 ...
 * scheduling and forgiving status checks, and liqiudating collateral shares
 */
abstract contract EVCClient is EVCUtil {
     ...
     * @dev This function controls the collateral in order to transfers the specified amoutn of shares from the
     * violator's vault of the liquidator

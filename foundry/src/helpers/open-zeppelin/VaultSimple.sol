...
contract VaultSimple is VaultBase, Ownable, ERC4626 {
    ...
    function doCheckVaultStatus(
        ...
        // sanity check in case the snapshot was not taken
        ...
        // the supply cap can be implemented in the derived contract
     ...
     * @dev That function is manipulate in its current form as it uses exact values. Considering that other vaults may
     * rely on it, for a production vault, a manipulation resistant mechanism should be used.
     ...
     * @param receiver The receiver of the redeemed shares
